...
function addWord(id) {
    ...
    let S1 = Math.floor(Math.random() * 3240);     // returns a random
    let S2 = Math.floor(Math.random() * 3240);     // returns a random
    let S3 = Math.floor(Math.random() * 3240);     // returns a random
    let S4 = Math.floor(Math.random() * 3240);     // returns a random
    // arrayReviewBoxLengths = [rA[S1].length, rA[S2].length, rA[S3].length, rA[S4].length]
    ...
    // rA[S4].length;
    let sentence = " "
    sentence = sentence.concat(arrayReviewBox[0], ". ", arrayReviewBox[1], ". ", arrayReviewBox[2], ". ", arrayReviewBox[3], ".") 
