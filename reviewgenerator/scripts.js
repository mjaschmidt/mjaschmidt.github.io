var rA = ["Beat was really chill",
    ...
    "Song is really well-written, structured, produced etc",
    ...
    "Song started off pretty good, that first verse impressed me, I was really feeling the flows here",
    ...
    "Overall the song just not really my taste",
    ...
    "The other artist has a nice voice, good vocal melodies",
    ...
    "The vocal performance was pretty good",
    ...
    "The rapper in the second verse sounds great",
    ...
    "The beat was chill, has this ethereal sound",
    ...
    "I dont feature instrumentals unfortunately",
    ...
    "Beat is simple but very nice to listen",
    "Good simple hook",
    ...
    "Solid song good vocalist and the beat was neat",
    ...
    "The instruments were a bit underwhelming",
    ...
    "The track has some nice use of instruments",
    ...
    "The beat is really underwhelming the melody is too boring/minimal",
    ...
    "I really like the beat and the chorus",
    ...
    "The voice is good so plenty of potential",
    ...
    "I didnt like the vocals that much",
    ...
    "The beat was chill",
    "Good production",
    "Sorry but was not really feeling this song",
    ...
    "It the song had a really chill and calming vibe",
    "She has a nice voice that is pleasant listen too",
    "The beat was sounded soothing",
    ...
    "The rapping is good, good flows and delivery of lines",
    "The beat was pretty good, very melodic",
    ...
    "The kick on every bar, its not my taste",
    ...
    "Solid vocal melodies in that first verse",
    ...
    "I like the background vocals in the chorus",
    ...
    "The beat overall sounds way too simple and lacking depth",
    ...
    "The chorus was not good enough, too repetitive",
    ...
    "Chorus was great",
    "Voice in second verse was great, very pleasant sounding",
    "Lot of talent vocally, the drums make it too busy for my (chill) playlist though",
    ...
    "The chorus was a bit underwhelming",
    ...
    "The vocal performance was definitely not bad by any means, there is potential, just try to show off your vocal skills a bit more or find another way to surprise the listener",
    "It just stayed a little too safe and basic",
    "Song has a really chill and wavy vibe",
    ...
    "Not begin and end with chorus",
    "Dont make songs like these 4 mins",
    ...
    "I wish the rap verses were longer",
    ...
    "The voice is not great, still room for improvement",
    ...
    "My playlists dont feature instrumental tracks",
    ...
    "The mix, in general, sounded great, love the crispy hat in there",
    "A very soothing low-end",
    "Songs like this take quite some patience on the listeners part as its slow and the melody is not necessarily catchy",
    "Its good music",
    "I was feeling the beat until that bass kicks in, it sounds off to me",
    "I like the vocal melodies you incorporate in the track, but the voice still needs to improve quite a bit (or maybe it can be fixed with melodyne/autotune) because some notes are pretty false",
    "Song is really well constructed though, you chose the right melodies, flows and lyrics",
    "Pretty chill vibe, you have a nice voice",
    "The beat was chill as well, a bit limited melodically, but sufficient",
    "Good chorus",
    "Solid production, I liked the beat",
    ...
    "The chorus was not so interesting in my opinion",
    "Great voice",
    "The beat is really nice",
    "Sounds mixed and mastered professionally",
    ...
    "Had a real Havana vibe to it, and the vocals were good kinda reminded me of erson Paak",
    "Well done",
    ...
    "I wasnt really feeling the beat of this song",
    ...
    "Could be that this style is just not for me",
    "Its a nice melodic song, well-written and produced",
    "I like the melodies you sing",
    "The voice still needs to improve",
    "The beat melody got a bit repetitive so it can have a bit more variation",
    ...
    "The beat sounds kinda amateurish to me",
    ...
    "I did not like the second verse",
    ...
    "The female had a very nice voice",
    ...
    "The hook has a catchy start so thats good",
    ...
    "It the voice of the vocalist sounded monotonous",
    ...
    "It it was a solid song but stays pretty average",
    ...
    "It the beat was kinda odd",
    "Plenty of room for improvement",
    "It the rapping was good and intense",
    ...
    "The verses were a pleasure listen too",
    ...
    "You have a nice voice, its very pleasant listen too",
    ...
    "Catchy hook",
    "Some of the lyrics were kinda bad",
    ...
    "The voice still has some room for improvement",
    ...
    "I think your rapping voice is good but it sounds a bit monotonous",
    ...
    "The rapping was great and the beat was good",
    ...
    "I found myself losing interest during the verses because the song sounds so tame and bland and the beat is not helping either",
    ...
    "The vocals put me off to be honest",
    ...
    "The beat is pretty nice, a little repetitive",
    ...
    "I dont really like the voice during the singing, the high pitch doesnt really sound good to me",
    ...
    "The hook lyrics are a tad cliche",
    "Overal the song doesnt really match my taste",
    ...
    "Structurally a good song and production was fine",
    ...
    "You did that pretty well, the flows you used were pretty good and you switched it up enough",
    ...
    "In the first half of the first verse the flow is kinda slow and choppy",
    ...
    "The song isnt exciting enough to me",
    ...
    "You made a pretty catchy hook",
    "The song has a nice vibe and a sweet melody",
    "You have a really nice voice to listen",
    ...
    "I think the beat was pretty good",
    "Its a nice song and its pleasant listen too",
    ...
    "Song is a bit too sweet and cute for my playlist",
    ...
    "The voice is fine and the beat is decent",
    ...
    "The beat is just too repetitive/too simple",
    ...
    "The singing is good",
    "It it was a pretty good song, a nice listen",
    ...
    "The hook It was bad, it lacked pace and energy",
    "The beat switch was interesting and I did like the second beat more",
    "The second verse was good",
    ...
    "The hook itself is better but a bit repetitive",
    ...
    "For the hook, I think you can make a more interesting hook, during the second hook you did some background vocals which improved it a lot already compared to the first hook",
    ...
    "Songs like this make or break on the voice, and I do think there is still room for improvement in that department, although im not sure if you can really improve that much and it wasnt bad, just not great",
    "The female vocalist is a really good singer, really in the last chorus it shined, a lot of intensity",
    "I really liked the lyrics of the song",
    "The rapping was pretty good",
    ...
    "In the chorus, the flow you do gets repetitive",
    ...
    "Seconds to start the first verse is too long",
    ...
    "The beat is pretty good and the rapping was good",
    ...
    "In general i think you have an interesting voice",
    ...
    "The hook is a bit boring, a bit too simple",
    ...
    "I didnt like the voice of the last verse and I also had trouble understanding him",
    ...
    "The song is a bit predictable like it lacks originality",
    ...
    "Chill beat and a nice voice to listen",
    "Its a pleasant song to listen",
    ...
    "Its not good enough",
    "The flows are alright and the beat is",
    ...
    "The rapping is of good quality",
    ...
    "To be honest, I am not feeling this song",
    "The rapping is alright (not great) but its mostly the beat that is not interesting to me",
    "Sorry for the bluntness, but I dont think the voice is good enough",
    "The beat is a bit boring",
    ...
    "It utilizes kicks well and the bassline is good",
    ...
    "Sorry for not loving this current song, could also just be my personal taste, of course.	1",
    "It was a chill song to listen",
    ...
    "I personally didnt like the chorus",
    ...
    "The beat is weird for me to really vibe too",
    ...
    "I like the song it was nice to listen",
    ...
    "Song is a bit too slow for any of my playlists",
    ...
    "You had some nice flows during the song",
    ...
    "Some parts of the verses went hard though, I liked the beginning of the second verse for instance",
    ...
    "Song is a bit monotonous, actually I mean the voice is",
    ...
    "Its an interesting song, I like the beat and rythm",
    ...
    "Song was pretty cool, hard flows and fun lyrics too listen too",
    ...
    "All together I dont think the song is good enough",
    ...
    "Singing is very nice and the accent",
    ...
    "It the verses were really good",
    ...
    "Some parts of the song let me down, the parts where there suddenly was no singing any more but just noises (right after the amazing chorus)",
    ...
    "I dont have any instrumentals on my playlists, unfortunately",
    ...
    "So, dont misunderstand, its not a bad song, just not new/unique enough for me.	",
    ...
    "Sorry for the bluntness but this is my honest opinion",
    ...
    "Song sounds fresh and new and up to date with current hip hop",
    "The hook is good",
    ...
    "Its a chill vibe",
    "I like the voice very soft and pleasant to listen",
    ...
    "Some voices I liek when they have that raw sound like JuiceWRLD or X but this one still needs to improve",
    ...
    "For the chorus, I am not in love with the singing",
    ...
    "But the singer during the chorus",
    ...
    "Good beat",
    "You have created a nice hook/chorus",
    "Pretty voice that is able to hit those high notes",
    "The vocalist sings in some interesting flows during the verses",
    ...
    "The hook is pretty good, a bit cliche",
    ...
    "The overall mixing/mastering of the voice is bad",
    ...
    "Song has a really nice beat, the piano is soothing and overall it jus tsounds like a vibe",
    "Really chill hook",
    ...
    "The beat just doesnt sound that interesting to me",
    ...
    "Its a pretty chill song to listen",
    ...
    "I really enjoy a version like this of the original song because I can actually understand what is said lol",
    ...
    "The vocalist has a nice voice",
    "This song produces some great vibes that people can dance",
    ...
    "I think you have a great voice - I mean the singing is really good",
    "Also, I like the chorus, its catchy, but it sounds a bit choppy",
    "A hard-hitting lively beat",
    "A lowkey hook that is simple and nice",
    "Some verses with good lyrics and a good flow",
    ...
    "Voice is nice and pleasant to listen",
    "Well done",
    ...
    "I have a hard time understanding what is said",
    ...
    "Sorry for the blunt honesty but I dont like the song enough to add it to my playlist",
    ...
    "I think the hook he made was great",
    ...
    "The hook is just not great, maybe you just repeated it once too much, also the outro could have been shortened",
    ...
    "Sounds great",
    "The vocalist sounds like a typical Rock artist. The electric guitar sounds really skilled.  I think the chorus sounds catchy. I dont have a playlist that suits Rock music though.	",
    ...
    "The hook is simple but catchy and fun",
    ...
    "I would look for a better songwriter.	",
    "Fun song",
    "The whole song has a chill vibe",
    "The hook is addictive",
    "Great singing and the rapping was pretty good",
    ...
    "You have a good accent for rap as well (the ATL accent",
    ...
    "I think both rappers did great, really fresh flows",
    "I love the band, the DRUMMER (great job",
    "And the guitarist are awesome",
    "The vocalist has an amazing voice",
    ...
    "So, in summary, this song is too monotonous, any point in the song feels like any other point - if that makes sense",
    "From the start, it has a very nice vibe with a pleasant voice",
    "Its a good song that works well",
    "I just wished there was a bit more variation throughout the song",
    "It would have been nice if there was either a feature, more beat switch-ups, or more flow switch-ups",
    ...
    "The chorus sounded pretty funky",
    "Aye this joint nice",
    "Really chill vibe",
    "Love when it switches up between the chorus and verses from chill to a more aggressive vibe",
    "I am just a sucker for that melodic instrument that is used - its just so wavy",
    ...
    "I personally think the chorus isnt that great,",
    "Another negative, I think the melody does get a bit repetitive, after a while",
    ...
    "I really like the climactic ending",
    ...
    "It could be just a personal taste of mine",
    ...
    "So, ultimately, I am passing on this song because of the voice",
    ...
    "I think the guitar sounds good",
    ...
    "I think there is room for improvement for the singing,",
    ...
    "The instrumental part with just the sound effects sounds good",
    ...
    "You have some range too, as proven in the end",
    ...
    "Beat production needs work",
    "I was not impressed by the string/brass instrument",
    "Melody needs more variation",
    ...
    "It makes it sound more amateurish",
    ...
    "The chorus is nice and actually catchy",
    ...
    "The voice brings a lot of energy in the track",
    ...
    "I find the chorus pretty boring and uninspired",
    ...
    "I like the voice of the vocalist",
    ...
    "Chorus is a bit boring",
    "Its a good song as far as technicality goes, but it just doesnt really pique my interest - so I wont be adding this one",
    "Sounds like a legit trap/club banger",
    ...
    "So, pretty good song - nice vibes, but I dont like it quite enough to add it to my playlist",
    ...
    "I think the piano melody is of insufficient quality to be played throughout the whole song",
    "I think this is a song that got the basics down and now the artist in his next songs needs to be more creative and put more effort in making an",
    "Interesting",
    ...
    "During the song, espescially at the end, I was still waiting for more of a climax that never really happened",
    ...
    "The lyrics are fun as well, a bit abrasive",
    ...
    "Ad-libs are great and get you hype",
    ...
    "Hand, it does give the beat a nice bounce and make it energetic",
